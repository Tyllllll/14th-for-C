...
extern uint8 row_DMA_flag;
extern int8  sampleover;
extern int sample_row;
extern int8  sampleover;
void img_extract(void);
void DMA_Complete_ISR(void);
void camera_delay(void);
extern uint8 ov7725_eagle_cfgnum;

extern uint8 Flag_ImageStart;
...
//extern uint8 Image_Buf[ROW][COLUMN / 8];
extern uint8 Camera_CNST;
extern uint8 Image_Buf[ROW + 10][COLUMN / 8];
extern uint8 Image_Buf2[ROW + 10][COLUMN / 8];
